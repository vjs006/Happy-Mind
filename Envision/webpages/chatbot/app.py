...
def chatbot(user_input):
    ...
    f1=open('webpages\\chat_model\\dataset_emotions.txt','r')
    f2=open('webpages\\chat_model\\userlog.txt','a')
...
def process_input():
    ...
    print("User Input from Webpage:", user_input)
    result = {'replies': chatbot(user_input)}  # Assuming chatbot is a function you've defined elsewhere
